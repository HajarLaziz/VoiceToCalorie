...
class SpacyNERExtractor:
    def __init__(self):
        ...
        try:
            ...
            print(f"[OK] Base nutritionnelle chargee: {len(self.nutrition_db)} aliments")
        ...
        try:
            ...
            try:
                ...
                self.available = True
                print("[OK] Mode spaCy actif")
            except OSError:
                print("[INFO] Mode simplifie (recherche par mots-cles)")
        except ImportError:
            print("[INFO] Mode simplifie (recherche par mots-cles)")
    ...
    def process(self, text: str) -> Tuple[Dict, Dict, float]:
        ...
        if not text or not text.strip():
            return {"foods": [], "quantities": [], "raw_text": text}, {"calories": 0, "proteines": 0, "glucides": 0, "lipides": 0}, 0.0
